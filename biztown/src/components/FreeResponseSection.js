  ...
  render() {
    return (
      <div>
        ...
        <p>
          11 - 13. Read the following information and complete the
          deposit ticket. <b>(3 points)</b>
        </p>
        <p>
          Mark Hill received his $62 paycheck. He’s going to a movie
          tonight, so he wants to get $20 cash when he makes his deposit
          at the bank.
        </p>
        <DepositForm
          data={this.props.data.depositForm}
          handleChange={(e) =>
            this.props.handleChange("depositForm", e)
          }
        />
        <p>
        ...
        <p>
          ...
          friends. He used his debit card to buy a new hat from Journeys
          for $5.00. He also bought a gift for his mom at Macy’s. The
          check he wrote was for $3.75.
        </p>
        <CheckSlip
        ...
        <RegisterSlip
          ...
          handleChange={(e) =>
            this.props.handleChange("registerEntries", e)
          }
        />
      </div>
    );
