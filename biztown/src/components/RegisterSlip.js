            ...
            <td className="table-border">
                {
                    ...
                    <input
                        className={`center-align no-border register-medium-col ${props.greyBackground ? "grey-background" : ""}`}
                        type="text"
                        id={`entryNumber_${row}`}
            ...
            <td className="table-border">
                {
                    ...
                    <input
                        className={`center-align no-border ${props.greyBackground ? "grey-background" : ""}`}
                        type="text"
            ...
            <td className="table-border">
                {
                    ...
                    <input
                        className={`center-align no-border register-large-medium-col ${props.greyBackground ? "grey-background" : ""}`}
                        type="text"
            ...
            <td className="table-border">
                {
                    ...
                    <input
                        className={`center-align no-border narrow-column ${props.greyBackground ? "grey-background" : ""}`}
                        type="text"
