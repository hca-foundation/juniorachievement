                ...
                >  
                    <div className="flex-container">
                        <div>
                            ...
                            <div className="deposit-form-small-text center-align">Deposits may not be available for immediate withdrawal.</div>
                            <div
                                className="table-border-bottom center-align"
                                style={{fontFamily: "cursive", marginTop:"15px", marginRight: "15px"}}
                            >
                                Mark Hill
                            </div>
                            <div
                        ...
                        <div style={{marginTop: "30px"}}>
                            ...
                            />
                            <div className="flex-container" style={{marginLeft: "10px", marginTop: "15px"}}>
                                <span>Acct. #</span>
                                <span
                                    className="flex-item-grow table-border-bottom"
    ...
    return (
        <table style={{width: "360px"}}>
            <tbody className="deposit-form center-align">
                <tr>
                    <td className="table-border" rowSpan="2" style={{width: "100px"}}>CASH</td>
