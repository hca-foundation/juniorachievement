...
class CheckSlip extends Component {
    ...
    */
    render () {
        return (
            <div className="deposit-form flex-container" style={{overflowX: "scroll"}}>
                <div
                ...
                >
                    ...
                    <div className="flex-container" style={{textAlign: "left", marginTop: "15px"}}>
                        <span
                    ...
                    <div className="flex-container" style={{marginTop: "15px"}}>
                        ...
                        <div>
                            <input
                                style={{border: "solid black", borderWidth: "0 0 1px 0", width: "450px", paddingTop: "5px"}}
                                id="q14_answer"
                                name="q14_answer"
                                type="text"
                    ...
                    >
                        <div>
                            <input
                                style={{border: "solid black", borderWidth: "0 0 1px 0", marginRight: "20px", width: "600px", paddingTop: "5px"}}
                                id="q15_answer"
                                name="q15_answer"
                                type="text"
                    ...
                    <div className="flex-container">
                        ...
                        <div>
                            <input
                                style={{border: "solid black", borderWidth: "0 0 1px 0", width: "300px", marginLeft: "30px", paddingTop: "5px"}}
                                id="q16_answer"
                                name="q16_answer"
                                type="text"
                    ...
                    <div style={{textAlign: "right", marginTop: "15px", paddingBottom: "15px"}}>
                        <span
                            style={{textAlign: "center", padding: "15px 15px 0 15px", marginRight: "15px"}}
                        ><b>Acct. #</b></span>
                        <span
