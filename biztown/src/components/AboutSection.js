...
const participationOptions = [ "This is my first time", "1", "2", "3", "4", "5 or more times" ];
    ...
    render () {
        ...
        return (
            ...
            <ol>
                ...
                <li className="form-group">
                    <div className="flex-column-container">
                        <label className="form-question">Where do yu go to school?</label>
                        <div className="flex-container">
                            <label className="form-question">School District:</label>
                        ...
                        <div className="flex-container">
                            ...
                            <SchoolSelectionComponent
                                ...
                                schoolOptions={this.props.schoolData[this.props.data.schoolDistrict]}
                                handleChange={this.props.handleChange}
                            />
                        </div>
                    </div>
                ...
                <li className="form-group">
                    <div className="flex-column-container">
                        <label className="form-question">What is your teacher's last name?</label>
                        <input
                            className="form-control form-control-text-input"
                            id="teacher"
                            name="teacher"
...
function SchoolDisctictComponent(props) {
    ...
    var schoolDistrictOptions = schoolDistricts && schoolDistricts.map(schoolDistrict => {
        return (
            <option
                key={schoolDistrict}
...
function SchoolSelectionComponent(props) {
    var schoolOptions = props.schoolOptions && props.schoolOptions.map(school => {
        return (
            <option
                key={school.id}
                name="schoolOption"
