...
class FormInputLayout extends Component {
    ...
    handleFreeResponseSectionChange = (bankFormType, event) => {
        ...
        if (bankFormType === "checkSlip") {
            this.setState(prevState => {
                var freeResponseData = JSON.parse(JSON.stringify(prevState.freeResponseData));
    ...
    handleSubmit = event => {
        ...
        var depositFormData = this.state.freeResponseData.depositForm.rowEntries;
        ...
        var registerFormData = this.state.freeResponseData.registerEntries.rowEntries;
        ...
        var submitPath = this.props.posttest ? "postassessment/" : "preassessment/";
        ...
        return (
            <div className="form-input" style={{ maxWidth: "900px", marginLeft: "auto", marginRight: "auto" }}>
                <Fragment>
                 ...
                 <h2 style={{ textAlign: "center", background: "#d59844", padding: "20px", marginTop: "0" }}>JA BizTown { this.props.posttest ? "Post" : "Pre" } Program Survey</h2>
